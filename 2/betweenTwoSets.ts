...
// 1. The goal is to know how many numbers exist such as: 
// - the number modulo each of the numbers in the first array is 0
// - the elements in the second array modulo the each of these numbers is 0
...
// the first array can be labeled as "factors of"
// the secodn array can be labeled as "products of"
// ## Step 2
...
// let's consider the inputs [2, 6], [24,36]
// let 's say I have "x" as a number that satisfies the conditions.
// 1.- Va E [a1,..,an], ak = x, k E N
// 2.- Vb E [b1,...,bn], xk = b, k EN
